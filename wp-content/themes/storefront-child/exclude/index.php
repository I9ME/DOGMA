...
<?php if ( is_home() ) : ?>
		...
		<div class="content content_3 youtube">
			<header class="headerSession">
				<h1 class="title"><i class="fa fa-youtube-play" aria-hidden="true"></i> YOUTUBE</h1>
				<br />
				<p class="legend">SIGA NOSSO CANAL</p>
			</header>
			<div class="mainContent">

			<?php // echo do_shortcode('[yourchannel user="Dogma Store"]') ?>

			<?php // echo do_shortcode('[Youtube_Channel_Gallery user="marapongamartmoda" key="AIzaSyDN-eZ_43rwW2ePdMKzEu6QeAxfxigYb-s" maxitems="3" thumb_columns_tablets="3" title="1"]') ?>

			<?php echo do_shortcode('[Youtube_Channel_Gallery identify_by="channelid"  user="UCk8Wr6idc4AV_fzB91idBGw"  key="AIzaSyDN-eZ_43rwW2ePdMKzEu6QeAxfxigYb-s" maxitems="3" thumb_columns_tablets="3" title="1"]') ?>
